# your_baseline3.py
#
# looking at previous experiment of baseline1 and baseline2
# Instead of focusing on improving Offensive Agent
# this baseline3 gives up on winning and uses 2 Defensive Agents
# also, added function to beeline towards closest enemy if there is no invader
...
class DefensiveReflexAgent(ReflexCaptureAgent):
    ...
    def getFeatures(self, gameState, action):
        ...
        # if there are no invaders, get close to the closest enemy
        # will there be any situation when this is not beneficial??
        elif len(invaders) == 0:
            dists = [self.getMazeDistance(
    ...
    def getWeights(self, gameState, action):
        return {'numInvaders': -1000, 'onDefense': 1000, 'invaderDistance': -10, 'stop': -100, 'reverse': -2}
